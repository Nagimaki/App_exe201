...
//     'https://severexe201-production.up.railway.app/payment';
//
// // Định nghĩa các gói thanh toán
// enum PaymentPackage { vip, vipPro }
//
...
//       return;
//     }
//     final int intAmt = _selectedPackage == PaymentPackage.vip ? 250000 : 500000;
//
//     setState(() {
//       _loading = true;
//       _checkoutUrl = null;
...
//           children: [
//             RadioListTile<PaymentPackage>(
//               title: const Text('Gói VIP 250.000đ'),
//               value: PaymentPackage.vip,
//               groupValue: _selectedPackage,
//               onChanged: _onPackageChanged,
//             ),
//             RadioListTile<PaymentPackage>(
//               title: const Text('Gói VIP Pro 500.000đ'),
//               value: PaymentPackage.vipPro,
//               groupValue: _selectedPackage,
//               onChanged: _onPackageChanged,
//             ),
//             const SizedBox(height: 12),
